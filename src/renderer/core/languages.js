window.languages = {
  ...
  "ar": {
    ...
    "exit": {
      "message": "هل ترغب في الخروج من التطبيق؟",
      "message_logout": "هل ترغب في تسجيل الخروج والخروج من التطبيق؟",
      "no": "لا",
      "yes": "نعم"
    },
    "search": {
  ...
  "ca": {
    ...
    "login": {
      ...
      "fill_fields": "Omple tots els camps.",
    ...
    "home": {
      ...
      "continue": "Continuar mirant"
    },
    "exit": {
      "message": "Voleu sortir de l'aplicació?",
      "message_logout": "Voleu tancar la sessió i sortir de l'aplicació?",
      "no": "No",
      "yes": "Sí"
    },
    "search": {
  ...
  "de": {
    ...
    "exit": {
      "message": "Möchten Sie die Anwendung verlassen?",
      "message_logout": "Möchten Sie sich abmelden und die Anwendung verlassen?",
      "no": "Nein",
      "yes": "Ja"
    },
    "search": {
  ...
  "fr": {
    ...
    "exit": {
      ...
      "message_logout": "Voulez-vous vous déconnecter et quitter l'application?",
      "no": "Non",
      "yes": "Oui"
    },
    "search": {
  ...
  "id": {
    ...
    "exit": {
      ...
      "message_logout": "Apakah Anda ingin keluar dan log out dari aplikasi?",
      "no": "Tidak",
      "yes": "Ya"
    },
    "search": {
  ...
  "it": {
    ...
    "exit": {
      ...
      "message_logout": "Vuoi effettuare il logout ed uscire dall'applicazione?",
      "no": "No",
      "yes": "Sì"
    },
    "search": {
  ...
  "ms": {
    ...
    "login": {
      ...
      "fill_fields": "Sila isi semua ruangan.",
    ...
    "home": {
      ...
      "continue": "Teruskan Menonton"
    },
    "exit": {
      "message": "Adakah anda mahu keluar dari aplikasi?",
      "message_logout": "Adakah anda mahu log keluar dan keluar dari aplikasi?",
      "no": "Tidak",
      "yes": "Ya"
    },
    "search": {
  ...
  "pl": {
    ...
    "home": {
      ...
      "details": {
        ...
        "episodes": "Odcinki",
        "related": "Podobne treści"
      },
      "episodes": {
        "watched": "Obejrzane"
      },
      "continue": "Kontynuuj oglądanie"
    },
    "exit": {
      "message": "Czy chcesz wyjść z aplikacji?",
      "message_logout": "Czy chcesz wylogować się i wyjść z aplikacji?",
      "no": "Nie",
      "yes": "Tak"
    },
    "search": {
  ...
  "pt": {
    ...
    "exit": {
      ...
      "message_logout": "Deseja fazer logout e sair do aplicativo?",
      "no": "Não",
      "yes": "Sim"
    },
    "search": {
  ...
  "ru": {
    ...
    "exit": {
      ...
      "message_logout": "Вы хотите выйти из системы и выйти из приложения?",
      "no": "Нет",
      "yes": "Да"
    },
    "search": {
  ...
  "th": {
    ...
    "login": {
      ...
      "fill_fields": "กรุณากรอกข้อมูลให้ครบทุกช่อง",
    ...
    "exit": {
      "message": "คุณต้องการออกจากแอปพลิเคชันหรือไม่?",
      "message_logout": "คุณต้องการออกจากระบบและออกจากแอปพลิเคชันหรือไม่?",
      "no": "ไม่",
      "yes": "ใช่"
    },
    "search": {
  ...
  "tr": {
    ...
    "exit": {
      ...
      "message_logout": "Çıkış yapmak ve uygulamadan çıkmak istiyor musunuz?",
      "no": "Hayır",
      "yes": "Evet"
    },
    "search": {
  ...
  "vi": {
    ...
    "login": {
      ...
      "fill_fields": "Vui lòng điền vào tất cả các trường.",
    ...
    "exit": {
      ...
      "message_logout": "Bạn có muốn đăng xuất và thoát khỏi ứng dụng không?",
      "no": "Không",
      "yes": "Có"
    },
    "search": {
