...
* **Native Controller Support**: Keep **Game Controller Support** enabled in the Crispyroll settings menu for out-of-the-box gamepad navigation.
...
Yes. To run at 1080p and scale to higher-resolution displays (e.g. 1440p or 4K):
```bash
gamescope -w 1920 -h 1080 -W 2560 -H 1440 -b -- ./Crispyroll.AppImage
```
